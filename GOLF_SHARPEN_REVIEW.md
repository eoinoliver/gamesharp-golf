...
The complete illustrated golfer journey is visible immediately as the opening hero, fitted rather than cropped. The three intention questions sit underneath as compact supporting choices. In landscape the full hero compresses to 150px and the three choices share one row; on portrait phones the hero keeps the full artwork visible and the choices remain reachable by normal scrolling.
