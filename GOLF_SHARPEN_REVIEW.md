...
- Service-worker shell updated to cache v19 with the current one-hole WebP and JPEG recovery asset, evicting every pre-simplified-Home shell and the retired journey artwork.
