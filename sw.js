...
const CACHE = 'gamesharp-golf-v17';
const SHELL = ['./', './index.html', './manifest.json', './icon.svg', './laytown-hero.jpg', './baltray-hero.jpg', './play-a-hole-hero.jpg', './play-a-course-hero.jpg', './gamesharp-one-hole-v1.webp'];
